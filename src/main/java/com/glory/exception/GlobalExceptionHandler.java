...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> buildErrorResponse(Exception error, HttpStatus status){
    ...
    public ResponseEntity<ErrorResponse> handleResourceNotFound(ResourceNotFoundException singleError){
    ...
    // @ExceptionHandler(ResourceNotFoundException.class){
    //     public ResponseEntity<Erroretails> handleResourceNotFoundException(ResourceNotFoundException singleError,
    //     WebRequest webRequest){
    //         ErrorDtails errorDtails = new ErrorDetails(new Date(), singleError.getMesaage(), webRequest.getDescription(false));
